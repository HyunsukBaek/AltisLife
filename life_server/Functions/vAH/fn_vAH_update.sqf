/*
	...
	Description: Sorts all db calls for the AOSoul AH
	Author: Fresqo
	inputs.
...
switch (_switch) do {
	...
	case 1: {
		...
		diag_log format["AOSoul Auction House: ITEM REMOVED: %1",_query];
		[] spawn TON_fnc_vAH_init;
	};
	case 2: {
	...
	case 3: {
		...
		[_query,1] call DB_fnc_asyncCall;
		diag_log format["AOSoul Auction House: ITEM SOLD: %1",_query];
