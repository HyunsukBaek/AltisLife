...
if(localize _type isEqualTo "보물") exitWith {hint localize "STR_NOTF_couldNotGiveItem";ctrlShow[2002,true];};// 보물은안돼!!
if(localize _type isEqualTo "뉴스마이크") exitWith {hint localize "STR_NOTF_couldNotGiveItem";ctrlShow[2002,true];};// 마이크도은안돼!!
