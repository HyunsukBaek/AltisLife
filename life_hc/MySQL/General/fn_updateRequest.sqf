...
for "_i" from 0 to count(_licenses)-1 do {
    private _bool = [(_licenses select _i) select 1] call HC_fnc_bool;
...
//PLAYTIME
private _playtime = [_uid] call HC_fnc_getPlayTime;
...
switch (_side) do {
    ...
    case civilian: {_query = format["UPDATE players SET name='%1', cash='%2', bankacc='%3', civ_licenses='%4', civ_gear='%5', arrested='%6', civ_stats='%7', civ_alive='%8', civ_position='%9', playtime='%10' WHERE playerid='%11'",_name,_cash,_bank,_licenses,_gear,[_this select 8] call HC_fnc_bool,_stats,[_this select 9] call HC_fnc_bool,_position,_playtime_update,_uid];};
