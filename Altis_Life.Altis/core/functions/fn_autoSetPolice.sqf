...
*/
if (life_cash > 199999) then //100k
{
	life_cash = life_cash - 200000;  //100k
	hintSilent "200000원이 차감되었습니다";
	sleep 2;
	...
	player addBackpack "B_Assault_Diver";
	...
	player addMagazine "16Rnd_9x21_Mag";
	player addMagazine "16Rnd_9x21_Mag";
	player addWeapon "HandGrenade_Stone"; //flashbang
	player addWeapon "HandGrenade_Stone"; //flashbang
