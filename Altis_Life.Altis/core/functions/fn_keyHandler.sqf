...
switch (_code) do {
	...
	case 38: {
		...
		if(_shift && playerSide in [west,independent]) then {
			if(vehicle player != player && (typeOf vehicle player) in ["C_Offroad_01_F","B_MRAP_01_F","C_SUV_01_F","C_Hatchback_01_F","C_Hatchback_01_sport_F","B_Heli_Light_01_F","B_Heli_Transport_01_F", "B_MRAP_01_hmg_F", "O_MRAP_02_F", "O_MRAP_02_hmg_F", "C_Van_01_box_F"]) then {
