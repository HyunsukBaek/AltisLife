...
if (!((player distance (getMarkerPos "police_hq_1") < 60) ||  (player distance (getMarkerPos "police_hq_2") < 60) || (player distance (getMarkerPos "cop_spawn_3") < 60) || (player distance (getMarkerPos "cop_spawn_5") < 60))) then  {
